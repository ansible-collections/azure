...
### NEW MODULES
  - azure_rm_firewallpolicy: New Module : azure_rm_firewallpolicy ([#705](https://github.com/ansible-collections/azure/pull/705))
  - azure_rm_privatelinkservice: Add some module relate with private link service ([#858](https://github.com/ansible-collections/azure/pull/858))
  - azure_rm_privatelinkservice_info: Add some module relate with private link service ([#858](https://github.com/ansible-collections/azure/pull/858))
  - azure_rm_privateendpointconnection: Add some module relate with private link service ([#858](https://github.com/ansible-collections/azure/pull/858))
  - azure_rm_privateendpointconnection_info: Add some module relate with private link service ([#858](https://github.com/ansible-collections/azure/pull/858))
  - azure_rm_natgateway: Add new module for Azure NAT gateway ([#860](https://github.com/ansible-collections/azure/pull/860))
  - azure_rm_natgateway_info: Add new module for Azure NAT gateway ([#860](https://github.com/ansible-collections/azure/pull/860))
  - azure_rm_bastionhost: Add azure_rm_bastionhost module ([#873](https://github.com/ansible-collections/azure/pull/873))
  - azure_rm_bastionhost_info: Add azure_rm_bastionhost module ([#873](https://github.com/ansible-collections/azure/pull/873))
  ...
  - azure_rm_virtualhubconnection: Add vhub connection module ([#939](https://github.com/ansible-collections/azure/pull/939))
  - azure_rm_virtualhubconnection_info: Add vhub connection module ([#939](https://github.com/ansible-collections/azure/pull/939))
  - azure_rm_aksagentpool: Add agentpool module ([#974](https://github.com/ansible-collections/azure/pull/974))
  - azure_rm_aksagentpool_info: Add agentpool module ([#974](https://github.com/ansible-collections/azure/pull/974))
  - azure_rm_aksagentpoolversion_info: Add agentpool module ([#974](https://github.com/ansible-collections/azure/pull/974))

### FEATURE ENHANCEMENT
  - azure_rm_container*: Azure container registry tags ([#830](https://github.com/ansible-collections/azure/pull/830))
  - azure_rm_loadbalancer: Add disable_outbound_snat configuration to azure_rm_loadbalancer module ([#744](https://github.com/ansible-collections/azure/pull/744))
  - azure_rm_manageddisk: Add support for ZRS disks in virtualdisk and manageddisk modules ([#855](https://github.com/ansible-collections/azure/pull/855))
  - azure_rm_virtualmachine: Add support for ZRS disks in virtualdisk and manageddisk modules ([#855](https://github.com/ansible-collections/azure/pull/855))
  - azure_rm_storage*: Update Storage dependencies ([#833](https://github.com/ansible-collections/azure/pull/833))
  - azure_rm_storageaccount: Configure static website on storage account ([#878](https://github.com/ansible-collections/azure/pull/878))
  - azure_rm_appserviceplace*: Update azure.mgmt.web ([#849](https://github.com/ansible-collections/azure/pull/849))
  - azure_rm_functionapp*: Update azure.mgmt.web ([#849](https://github.com/ansible-collections/azure/pull/849))
  - azure_rm_webapp*: Update azure.mgmt.web ([#849](https://github.com/ansible-collections/azure/pull/849))
  - azure_rm_manageddisk: Support to mount disk to multiple VMs ([#867](https://github.com/ansible-collections/azure/pull/867))
  - azure_rm_manageddisk_info: Support to mount disk to multiple VMs ([#867](https://github.com/ansible-collections/azure/pull/867))
  - azure_rm_storageaccount: Update storage account to allow configuration of public network access ([#875](https://github.com/ansible-collections/azure/pull/875))
  - azure_rm_storageaccount_info: Update storage account to allow configuration of public network access ([#875](https://github.com/ansible-collections/azure/pull/875))
  - azure_rm_dns*: Upgrade azure-mgmt-dns to 8.0.0 ([#879](https://github.com/ansible-collections/azure/pull/879))
  - README.md: Added prompt to install virtual environment in README. md ([#910](https://github.com/ansible-collections/azure/pull/910))
  - azure_rm_cognitivesearch: Upgrade azure-mgmt-search to 8.0.0 ([#896](https://github.com/ansible-collections/azure/pull/896))
  - azure_rm_cognitivesearch_info: Upgrade azure-mgmt-search to 8.0.0 ([#896](https://github.com/ansible-collections/azure/pull/896))
  - azure_rm_manageddisk: Add multi task support to attach manageddisk on VM ([#909](https://github.com/ansible-collections/azure/pull/909))
  - azure_rm_privatedns*: Upgrade azure-mgmt-privatedns to 1.0.0 ([#880](https://github.com/ansible-collections/azure/pull/880))
  - meta/runtime.yml: Adding an all group for module_defaults ([#874](https://github.com/ansible-collections/azure/pull/874))
  - azure_rm_aks*: Upgrade azure-mgmt-containerservice to 20.0.0 ([#881](https://github.com/ansible-collections/azure/pull/881))
  - azure_rm_containerinstance*: Upgrade azure-mgmt-containerinstance to 9.0.0 ([#882](https://github.com/ansible-collections/azure/pull/882))
  - azure_rm_mysql*: Upgrade azure-mgmt-rdbms to 10.0.0 ([#884](https://github.com/ansible-collections/azure/pull/884))
  - azure_rm_mariadb*: Upgrade azure-mgmt-rdbms to 10.0.0 ([#884](https://github.com/ansible-collections/azure/pull/884))
  - azure_rm_postgresql*: Upgrade azure-mgmt-rdbms to 10.0.0 ([#884](https://github.com/ansible-collections/azure/pull/884))
  - azure_rm_trafficmanager*: Upgrade azure-mgmt-trafficmanager to 1.0.0 ([#886](https://github.com/ansible-collections/azure/pull/886))
  - azure_rm_loganalyticsworkspace: Upgrade azure-mgmt-loganalytics to 12.0.0 ([#888](https://github.com/ansible-collections/azure/pull/888))
  - azure_rm_loganalyticsworkspace_info: Upgrade azure-mgmt-loganalytics to 12.0.0 ([#888](https://github.com/ansible-collections/azure/pull/888))
  - azure_rm_servicebus*: Upgrade azure-mgmt-servicebus to 7.1.0 ([#889](https://github.com/ansible-collections/azure/pull/889))
  - azure_rm_iothub*: Upgrade azure-mgmt-iothub to 2.2.0 ([#892](https://github.com/ansible-collections/azure/pull/892))
  - azure_rm_datalakestore: Upgrade azure-mgmt-datalake-store to 1.0.0 ([#898](https://github.com/ansible-collections/azure/pull/898))
  - azure_rm_datalakestore_info: Upgrade azure-mgmt-datalake-store to 1.0.0 ([#898](https://github.com/ansible-collections/azure/pull/898))
  ...
  - azure_rm_eventhub: Upgrade azure-mgmt-eventhubs to 10.1.0 ([#900](https://github.com/ansible-collections/azure/pull/900))
  - azure_rm_eventhub_info: Upgrade azure-mgmt-eventhubs to 10.1.0 ([#900](https://github.com/ansible-collections/azure/pull/900))
  - azure_rm_notificationhub: Upgrade azure-mgmt-notificationhubs to 8.0.0 ([#899](https://github.com/ansible-collections/azure/pull/899))
  - azure_rm_notificationhub_info: Upgrade azure-mgmt-notificationhubs to 8.0.0 ([#899](https://github.com/ansible-collections/azure/pull/899))
  - azure_rm_virtualnetworkgateway: Vpngw generation add ([#921](https://github.com/ansible-collections/azure/pull/921))
  - azure_rm_manageddisk: Add missing parameters ([#925](https://github.com/ansible-collections/azure/pull/925))
  - azure_rm_virtualmachine: Add new parameters to azure_rm_virtualmachine ([#933](https://github.com/ansible-collections/azure/pull/933))
  - azure_rm_storageaccount: Add new parameter to azure_rm_storageaccount ([#937](https://github.com/ansible-collections/azure/pull/937))
  - azure_rm_storageaccount_info: Add new parameter to azure_rm_storageaccount ([#937](https://github.com/ansible-collections/azure/pull/937))
  - azure-pipelines.yml: Update CI agent ([#949](https://github.com/ansible-collections/azure/pull/949))
  - pr-pipelines.yml: Update CI agent ([#949](https://github.com/ansible-collections/azure/pull/949))
  - release-pipelines: Update CI agent ([#949](https://github.com/ansible-collections/azure/pull/949))
  - azure-pipelines.yml: Update CI agent ([#950](https://github.com/ansible-collections/azure/pull/950))
  - pr-pipelines.yml: Update CI agent ([#950](https://github.com/ansible-collections/azure/pull/950))
  - release-pipelines: Update CI agent ([#950](https://github.com/ansible-collections/azure/pull/950))
  - azure_rm_cdn*: Upgrade azure-mgmt-cdn to 11.0.0 ([#945](https://github.com/ansible-collections/azure/pull/945))
  - azure_rm_registration*: Upgrade azure-mgmt-managedservices to 6.0.0 ([#948](https://github.com/ansible-collections/azure/pull/948))
  - azure_rm_hdinsightcluster: Upgrade hdinsight dependence to 9.0.0 ([#951](https://github.com/ansible-collections/azure/pull/951))
  - azure_rm_hdinsightcluster_info: Upgrade hdinsight dependence to 9.0.0 ([#951](https://github.com/ansible-collections/azure/pull/951))
  - azure_rm_role*: Upgrade azure-mgmt-authorizaiton to 2.0.0 ([#955](https://github.com/ansible-collections/azure/pull/955))
  - azure_rm_cosmosdbaccount: Upgrade azure-mgmt-cosmosdb to 6.4.0 ([#952](https://github.com/ansible-collections/azure/pull/952))
  - azure_rm_cosmosdbaccount_info: Upgrade azure-mgmt-cosmosdb to 6.4.0 ([#952](https://github.com/ansible-collections/azure/pull/952))
  - azure_rm_privateendpoint_info: Add connection details to azure_rm_privateendpoint_info ([#965](https://github.com/ansible-collections/azure/pull/965))
  - azure_rm_aks: Add ability to upgrade nodepool kubernetes version ([#966](https://github.com/ansible-collections/azure/pull/966))
  - azure_rm_keyvault*: upgrade azure-mgmt-keyvault to 10.0.0 ([#959](https://github.com/ansible-collections/azure/pull/959))
  - azure_rm_virtualmachinescaleset: Add os_disk_size_gb to azure_rm_virtualmachinescaleset.py ([#961](https://github.com/ansible-collections/azure/pull/961))
  ...
  - azure_rm_storageaccount: Add new parameter is_hns_enabled to azure_rm_storageaccount.py ([#998](https://github.com/ansible-collections/azure/pull/998))
  - azure_rm_storageaccount_info: Add new parameter is_hns_enabled to azure_rm_storageaccount.py ([#998](https://github.com/ansible-collections/azure/pull/998))

### BUG FIXING
  - azure_rm_keyvault_info: Fix azure_rm_keyvault_info 'Resource' object has no attribute 'properties' ([#872](https://github.com/ansible-collections/azure/pull/872https://github.com/ansible-collections/azure/pull/872))
  - azure_rm_aks: Changed aad_profile.admin_group_object_ids to take a list of string ([#865](https://github.com/ansible-collections/azure/pull/865))
  - azure_rm_manageddisk: If the disk exists, obtain unconfigured parameters ([#876](https://github.com/ansible-collections/azure/pull/876))
  - azure_rm_deployment_info: Fixing issue #856 with deployment info for a resource group and adding supporting test ([#857](https://github.com/ansible-collections/azure/pull/857))
  - azure_rm_manageddisk: Add required option when importing a disk image ([#877](https://github.com/ansible-collections/azure/pull/877))
  - azure_rm_publicipaddress: Fix the azure_rm_publicaddress module small bug ([#908](https://github.com/ansible-collections/azure/pull/908)
  - requirements-azure.txt: Update azure-mgmt-core to v1.3.0 ([#907](https://github.com/ansible-collections/azure/pull/907))
  - tests/integration/targets/azure_rm_storageshare/tasks/main.yml: After deleting storageshare, pause it for 3 minutes ([#913](https://github.com/ansible-collections/azure/pull/913))
  - azure_rm_keyvault*: Fixes required for use with multiple Cloud Environments ([#854](https://github.com/ansible-collections/azure/pull/854))
  - azure_rm_common: Replace config with _config in azure_rm_common.py to support azure-mgmt-network latest version ([#904](https://github.com/ansible-collections/azure/pull/904))
  - azure_rm_keyvault: Expose soft_delete_retention_in_days in Azure Key Vault module ([#906](https://github.com/ansible-collections/azure/pull/906))
  - azure_rm_aks: Fix the authorized_ip_ranges parameter being None ([#912](https://github.com/ansible-collections/azure/pull/912))
  - azure_rm_virtualmachine: Remove started default parameters ([#915](https://github.com/ansible-collections/azure/pull/915))
  - azure_rm_keyvaultkey: Adding missing functionality to azure_rm_keyvaultkey ([#930](https://github.com/ansible-collections/azure/pull/930))
  - azure_rm_storageaccount: Add missing account type of Standard_GZRS and Standard_RAGZRS ([#931](https://github.com/ansible-collections/azure/pull/931))
  - meta/runtime.yml: Fix a typo in runtime.yml for azure_rm_virtualmachinescalesetinstance_info ([#935](https://github.com/ansible-collections/azure/pull/935))
  - azure_rm_common: Fix azurerm MSI authentication with other Azure Cloud ([#894](https://github.com/ansible-collections/azure/pull/894))
  - azure_rm_common: Fix a sanity error ([#946](https://github.com/ansible-collections/azure/pull/946))
