...
### NEW MODULES
  ...
  - ignore-2.14.txt: Sanity tests: copy ignore-2.13.txt to ignore-2.14.txt ([#816](https://github.com/ansible-collections/azure/pull/816))
  - azure_rm_openshiftmanagedcluster_info: Add azure_rm_openshiftmanagedcluster_info module ([#755](https://github.com/ansible-collections/azure/pull/755))
  - azure_keyvault_secret.py: Keyvault Lookup Plugin Added ([#109](https://github.com/ansible-collections/azure/pull/109))
...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_loadbalancer: Add parameter zones to azure_rm_loadbalancer ([#801](https://github.com/ansible-collections/azure/pull/801))
  - azure_rm_loadbalancer_info: Add parameter zones to azure_rm_loadbalancer ([#801](https://github.com/ansible-collections/azure/pull/801))
  - azure_rm.py: Update azure_rm examples ([#810](https://github.com/ansible-collections/azure/pull/810))
  - azure_rm_virtualmachinescaleset: Upgrade azure-mgmt-compute to v26.1.0 ([#779](https://github.com/ansible-collections/azure/pull/779))
  - azure_rm_virtualmachinescaleset_info: Upgrade azure-mgmt-compute to v26.1.0 ([#779](https://github.com/ansible-collections/azure/pull/779))
  - azure_rm_rediscache: Update Redis modules ([#680](https://github.com/ansible-collections/azure/pull/680))
  - azure_rm_rediscache_info: Update Redis modules ([#680](https://github.com/ansible-collections/azure/pull/680))
  - azure_rm_rediscachefirewallrule: Update Redis modules ([#680](https://github.com/ansible-collections/azure/pull/680))
  ...
  - azure_rm_sql*: SQL Database enhancements ([#681](https://github.com/ansible-collections/azure/pull/681))
  - azure_rm_common.py: SQL Database enhancements ([#681](https://github.com/ansible-collections/azure/pull/681))
  - azure_rm_cosmosdbaccount: CosmosDB enhancements ([#675](https://github.com/ansible-collections/azure/pull/675))
  - azure_rm_cosmosdbaccount_info: CosmosDB enhancements ([#675](https://github.com/ansible-collections/azure/pull/675))
  - azure_rm_publicipaddress: Add zones parameter to azure_rm_publicipaddres module ([#829](https://github.com/ansible-collections/azure/pull/829))
  - azure_rm_publicipaddress_info: Add zones parameter to azure_rm_publicipaddres module ([#829](https://github.com/ansible-collections/azure/pull/829))
  - azure_rm_image: Add hyper_v_generation parameter to azure_rm_image module ([#832](https://github.com/ansible-collections/azure/pull/832))
  - azure_rm_image_info: Add hyper_v_generation parameter to azure_rm_image module ([#832](https://github.com/ansible-collections/azure/pull/832))
...
### BUG FIXING
  ...
  - azure_rm_*: Update the document to meet the change requirements of ansibe2.14 ([#814](https://github.com/ansible-collections/azure/pull/814))
  ...
  - azure_rm_virtualmachine: Fix azure rm virtualmachine top issue ([#767](https://github.com/ansible-collections/azure/pull/767))
  ...
  - CONTRIBUTING.md: Install collection to local directory during development ([#763](https://github.com/ansible-collections/azure/pull/763))
  - galaxy.yml: Install collection to local directory during development ([#763](https://github.com/ansible-collections/azure/pull/763))
  ...
  - azure_rm_*_info: Change the tags type of the Info module to list and the element type to string ([#821](https://github.com/ansible-collections/azure/pull/680))
