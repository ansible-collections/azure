...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_servicebusqueue:
    - Support tags to azure_rm_servicebusqueue.py ([#1114](https://github.com/ansible-collections/azure/pull/1114))
    - Add max_message_size_in_kilobytes to azure_rm_servicebusqueue.py ([#1092](https://github.com/ansible-collections/azure/pull/1092))
  - azure_rm_servicebuspolicy: Support tags to azure_rm_servicebuspolicy.py ([#1114](https://github.com/ansible-collections/azure/pull/1114))
  - azure_rm_servicebustopic:
    - Support tags to azure_rm_servicebustopic.py ([#1114](https://github.com/ansible-collections/azure/pull/1114))
    - Add max_message_size_in_kilobytes to azure_rm_servicebusqueue.py ([#1092](https://github.com/ansible-collections/azure/pull/1092))
  - plugins/doc_fragments/azure_rm: add description for include_vm_resource_groups of inventory ([#1077](https://github.com/ansible-collections/azure/pull/1077))
  - azure_rm_galleryimageversion: Fix append_tags for galleryimageversion ([#1100](https://github.com/ansible-collections/azure/pull/1100))
  - azure_rm_lock: Support notes to azure_rm_lock.py ([#1097](https://github.com/ansible-collections/azure/pull/1097))
  ...
  - azure_rm_virtualmachine:
    ...
    - Add the type of managed_disk_type ([#1136](https://github.com/ansible-collections/azure/pull/1136))
  - azure_rm_virtualmachinescaleset:
    - Upgrade azure-mgmt-marketplaceordering to 1.1.0 ([#940](https://github.com/ansible-collections/azure/pull/940))
    - Add the type of managed_disk_type ([#1136](https://github.com/ansible-collections/azure/pull/1136))
  - azure_rm_virtualnetworkpeering_info: Add peering_sync_level to return values of in azure_rm_virtualnetworkpeering_info ([#1085](https://github.com/ansible-collections/azure/pull/1085))
  - azure_rm_containerinstance: Add subnet_ids to azure_rm_containerinstance.py ([#1090](https://github.com/ansible-collections/azure/pull/1090))
  - azure_rm_containerinstance_info: Add subnet_ids to azure_rm_containerinstance.py ([#1090](https://github.com/ansible-collections/azure/pull/1090))
  - azure_rm_storageaccount: Add support for storage failover ([#1141](https://github.com/ansible-collections/azure/pull/1141))


### BUG FIXING
  - main.yml: Fixed return values in azure_rm_loganalyticsworkspace test cases ([#1129](https://github.com/ansible-collections/azure/pull/1129))
  ...
  - azure_rm_webapp:
    - Support python to create webapp ([#1128](https://github.com/ansible-collections/azure/pull/1128))
  ...
  - azure_rm_networkinterace: Fix azure_rm_networkinterface.py idempotent fail ([#1037](https://github.com/ansible-collections/azure/pull/1037))
  ...
  - azure_rm_snapshot: Add incremental to azure_rm_snapshot ([#1135](https://github.com/ansible-collections/azure/pull/1135))
  - azure_rm_appgateway: fix version_added in azure_rm_appgateway module document ([#1139](https://github.com/ansible-collections/azure/pull/1139))
  - azure_rm_*: Documentation fixes ([#1151](https://github.com/ansible-collections/azure/pull/1151))
  - azure_rm_devtestalb/aliases: Disable azure_re_devtestlab test ([#1144](https://github.com/ansible-collections/azure/pull/1144))
  ...
  - azure_rm_cdnendpoint: Fixed Failed to clear CND endpoint ([#1154](https://github.com/ansible-collections/azure/pull/1154))
  - azure_rm_resource_info: Add the method parameter to specify how http gets information ([#1158](https://github.com/ansible-collections/azure/pull/1158))
  - azure_keyvault_secret: Added azure cli credential support in the azure_keyvault_secret.py plugin ([#1161](https://github.com/ansible-collections/azure/pull/1161))
