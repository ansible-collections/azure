...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_virtualmachine_info: Verify that the VM is created after it is created ([#657](https://github.com/ansible-collections/azure/pull/657))
  ...
  - azure_rm_dnsrecordset: Added Metadata support to azure_rm_dnsrecordset.py ([#589](https://github.com/ansible-collections/azure/pull/589))
...
### BUG FIXING
  ...
  - azure_rm_appgateway: Correct doc for azure_rm_appgateway state ([#674](https://github.com/ansible-collections/azure/pull/674))
