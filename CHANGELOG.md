...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_servicebusqueue:
    ...
    - Add `max_message_size_in_kb` to azure_rm_servicebusqueue.py ([#1092](https://github.com/ansible-collections/azure/pull/1092))
...
### BUG FIXING
  ...
  - azure_keyvault_secret: Add azure cli credential support in the azure_keyvault_secret.py plugin ([#1161](https://github.com/ansible-collections/azure/pull/1161))
