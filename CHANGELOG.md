...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_networkinterface_info: Return the subnet ID in azure_rm_networkinterface_info.py ([#1462](https://github.com/ansible-collections/azure/pull/1462))
  - azure_rm_appgateway: Add support for 'port' and 'match' to azure_rm_appgateway.py's probes ([#1470](https://github.com/ansible-collections/azure/pull/1470))
  - azure_rm_common.py:
    - Support for azure-mgmt-recoveryservicesbackup v4.0+ ([#1469](https://github.com/ansible-collections/azure/pull/1469))
  ...
  - azure_rm_aksversion_info: Add support for 'allow_preview' to azure_rm_aksversion_info ([#1456](https://github.com/ansible-collections/azure/pull/1456))
  - azure_rm_adgroup: Add Support 'description' to azure_rm_adgroup ([#1492](https://github.com/ansible-collections/azure/pull/1492))
  - azure_rm_adgroup_info: Add 'description' to azure_rm_adgroup_info return ([#1492](https://github.com/ansible-collections/azure/pull/1492))
  ...
  - azure_rm_adapplication: Support spa_redirect_urls and public_client_redirect_urls ([#1494](https://github.com/ansible-collections/azure/pull/1494))
  - azure_rm_adapplication_info: Add 'spa_redirect_urls' and 'public_client_redirect_urls' to azure_rm_adapplication_info return ([#1494](https://github.com/ansible-collections/azure/pull/1494))
  - azure_rm_galleryimage: Add support 'architecture' to azure_rm_galleryimage ([#1493](https://github.com/ansible-collections/azure/pull/1493))
  - azure_rm_keyvaultkey: Support to recover/purge delete secret ([#1489](https://github.com/ansible-collections/azure/pull/1489))
  - azure_rm_keyvaultkey_info: Support to recover/purge delete secret ([#1489](https://github.com/ansible-collections/azure/pull/1489))
  - azure_rm_keyvaultsecret: Support to recover/purge delete secret ([#1489](https://github.com/ansible-collections/azure/pull/1489))
  - azure_rm_keyvaultsecret_info: Support to recover/purge delete secret ([#1489](https://github.com/ansible-collections/azure/pull/1489))
  - azure_rm_recoveryservicesvault_info: Support to list the vaults in same resource group ([#1487](https://github.com/ansible-collections/azure/pull/1487))
  - azure_rm_resource_info: Add support 'tags' option to azure_rm_resource_info module ([#1498](https://github.com/ansible-collections/azure/pull/1487))
  - azure_rm_aduser: Add support 'company_name' to azure_rm_aduser ([#1504](https://github.com/ansible-collections/azure/pull/1504))
  - azure_rm_aduser_info: Add 'company_name' to azure_rm_aduser_info return value ([#1504](https://github.com/ansible-collections/azure/pull/1504))
  - azure_rm_aks: Support to manage pod identities in managed Kubernetes cluster ([#1497](https://github.com/ansible-collections/azure/pull/1497))
  ...
  - azure_rm_virtualmachie: Support to swap OS disk ([#1435](https://github.com/ansible-collections/azure/pull/1435))

### BUG FIXING
  - azure_rm_adgroup: Fix unsuppoeted header in azure_rm_adgroup ([#1467](https://github.com/ansible-collections/azure/pull/1467))
  - azure_rm_keyvaultkey_info: Documentation typo fixes + typo fix in code ([#1468](https://github.com/ansible-collections/azure/pull/1468))
  - azure_rm_sqlmanagedinstance: Documentation typo fixes + typo fix in code ([#1468](https://github.com/ansible-collections/azure/pull/1468))
  - azure_rm_sqlmanagedinstance_info: Documentation typo fixes + typo fix in code ([#1468](https://github.com/ansible-collections/azure/pull/1468))
  - azure_rm_virtualmachine: Documentation typo fixes + typo fix in code ([#1468](https://github.com/ansible-collections/azure/pull/1468))
  ...
  - azure_rm_galleryimageversion_info: Check that the return value is None and do not serialize ([#1436](https://github.com/ansible-collections/azure/pull/1436)
  - azure_rm_servicebus_info: Fixed an error in formatting the return value ([#1503](https://github.com/ansible-collections/azure/pull/1503))
  ...
  - azure_rm_datalakestore: Delete azure_rm_datalakestore.py due to the Azure Data Lake Store retired ([#1501](https://github.com/ansible-collections/azure/pull/1501))
  - azure_rm_datalakestore_info: Delete azure_rm_datalakestore_info.py due to the Azure Data Lake Store retired ([#1501](https://github.com/ansible-collections/azure/pull/1501))
...
- azure_rm_account_info: Modify the default value of is_ad_resource in azure_rm_account_info.py to True ([#1510](https://github.com/ansible-collections/azure/pull/1510))
