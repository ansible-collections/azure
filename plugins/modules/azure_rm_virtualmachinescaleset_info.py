...
description:
    ...
    - Note that this module was called M(azure_rm_virtualmachine_scaleset_facts.py) before Ansible 2.8. The usage did not change.
...
options:
    ...
    format:
        description:
            ...
            - If C(curated) is selected the structure will be identical to input parameters of M(azure_rm_virtualmachinescaleset.py) module.
