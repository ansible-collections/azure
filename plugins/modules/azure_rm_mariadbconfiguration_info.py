...
class AzureRMMariaDbConfigurationInfo(AzureRMModuleBase):
    ...
    def exec_module(self, **kwargs):
        ...
        if is_old_facts:
            self.module.deprecate("The 'azure_rm_mariadbconfiguration_facts' module has been renamed to 'azure_rm_mariadbconfiguration_info'", version='ansible.builtin:2.9')
