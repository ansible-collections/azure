...
database:
    ...
    contains:
        id:
            ...
            returned: always
            type: str
            sample: "/subscriptions/xxx-xxx/resourceGroups/testRG/providers/Microsoft.DBforPostgreSQL/flexibleServers/postfle9/virtualendpoints/freddatabase"
        name:
            description:
                - Resource name.
            returned: always
...
class AzureRMPostgreSqlFlexibleVirtualEndpointInfo(AzureRMModuleBase):
    def __init__(self):
        ...
        super(AzureRMPostgreSqlFlexibleVirtualEndpointInfo, self).__init__(self.module_arg_spec, supports_check_mode=True, supports_tags=False, facts_module=True)
