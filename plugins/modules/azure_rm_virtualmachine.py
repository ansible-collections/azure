...
description:
    ...
    - Supports images from the Azure Marketplace, which can be discovered with M(azure_rm_virtualmachineimage_info.py).
...
options:
    ...
    data_disks:
        description:
            ...
            - Use M(azure_rm_mangeddisk.py) to manage the specific disk.
        suboptions:
            lun:
                description:
