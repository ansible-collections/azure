...
class AzureHost(object):
    ...
    def hostvars(self):
        ...
        if self._type == 'microsoft.compute/virtualmachines' or \
            self._type == 'microsoft.compute/virtualmachinescalesets/virtualmachines' or \
            self._type == 'microsoft.azurestackhci/virtualmachineinstances':
