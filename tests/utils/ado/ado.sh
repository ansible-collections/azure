...
export AZURE_SUBSCRIPTION_SEC_ID=${AZURE_SUBSCRIPTION_SEC_ID}
export AZURE_TENANT=${AZURE_TENANT}
export RESOURCE_GROUP=${RESOURCE_GROUP}
export RESOURCE_GROUP_SECONDARY=${RESOURCE_GROUP_SECONDARY}
export RESOURCE_GROUP_THIRD=${RESOURCE_GROUP_THIRD}
export RESOURCE_GROUP_DATALAKE=${RESOURCE_GROUP_DATALAKE}
export AZURE_PRINCIPAL_ID=${AZURE_PRINCIPAL_ID}
export AZURE_MANAGED_BY_TENANT_ID=${AZURE_MANAGED_BY_TENANT_ID}
export AZURE_ROLE_DEFINITION_ID=${AZURE_ROLE_DEFINITION_ID}
